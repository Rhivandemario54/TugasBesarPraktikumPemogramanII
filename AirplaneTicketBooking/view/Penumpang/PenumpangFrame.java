...
public class PenumpangFrame extends JFrame {
    ...
    public PenumpangFrame(List<AsalTerbang> asalTerbangList, List<TujuanTerbang> tujuanTerbangList, List<Penumpang> penumpangList){  
        ...
        PenumpangButtonSimpanActionListener actionListener = new PenumpangButtonSimpanActionListener(this);
